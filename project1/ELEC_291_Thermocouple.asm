; Task 1: Take values from ADC
; Task 2: Convert values from ADC into binary numbers
; Task 3: Convert binary ADC values into BCD
; Task 4: Convert BCD values into ASCII codes
; Task 5: Send ASCII codes into the serial port (Can be sent to PuTTy)
; Task 6: Receive ASCII codes in python program that reads from serial port
; Task 7: Plot data in python program
...
test_message:     db '', 0
value_message:    db 'Temperature      ', 0

temperature_message: db 'Temperature', 0
degrees_celsius: db '�C', 0
newline_char: db '\r','\n', 0
dot_char: db '.', 0
...
bcd: ds 5
VLED_ADC: ds 2
VTC_ADC: ds 2 ; Temporary storage for thermocouple ADC reading
BCD_335: ds 4 ; Temporary storage for the 355 BCD
...
Forever:
	...
	; To convert BCD to ASCII add 30 to each byte
;	mov dptr, #bcd
;	movx a, @dptr
;	mov r1, a
;	anl a, #0f0h
