...
TIMER0_RATE_A   EQU 4096    ; 2048Hz squarewave (peak amplitude of CEM-1203 speaker)
TIMER0_RELOAD_A EQU ((65536-(CLK/TIMER0_RATE_A)))

TIMER0_RATE_B   EQU  1976   ; 2048Hz squarewave (peak amplitude of CEM-1203 speaker)
TIMER0_RELOAD_B EQU ((65536-(CLK/TIMER0_RATE_B)))

TIMER0_RATE_C   EQU 2093     ; 2048Hz squarewave (peak amplitude of CEM-1203 speaker)
TIMER0_RELOAD_C EQU ((65536-(CLK/TIMER0_RATE_C)))

TIMER0_RATE_D   EQU 2349   ; 2048Hz squarewave (peak amplitude of CEM-1203 speaker)
TIMER0_RELOAD_D EQU ((65536-(CLK/TIMER0_RATE_D)))

TIMER0_RATE_E   EQU 2637     ; 2048Hz squarewave (peak amplitude of CEM-1203 speaker)
TIMER0_RELOAD_E EQU ((65536-(CLK/TIMER0_RATE_E)))

TIMER0_RATE_F   EQU 2794   ; 2048Hz squarewave (peak amplitude of CEM-1203 speaker)
TIMER0_RELOAD_F EQU ((65536-(CLK/TIMER0_RATE_F)))

TIMER0_RATE_G   EQU 3136     ; 2048Hz squarewave (peak amplitude of CEM-1203 speaker)
...
menu_state: ds 1
Note:    ds 1 ; 0 = a, 1 = b, 2 = c, 3 = d, 4 = e, 5 =f, 6 = g
...
Timer0_ISR:
	...
	cjne a, #2, Play_D
	clr TR0
	mov TH0, #high(TIMER0_RELOAD_C)
	mov TL0, #low(TIMER0_RELOAD_C)
	setb TR0
	cpl SOUND_OUT ; Connect speaker the pin assigned to 'SOUND_OUT'!
	reti
	Play_D:
	...
	cjne a, #5, Play_G
	clr TR0
	mov TH0, #high(TIMER0_RELOAD_F)
	mov TL0, #low(TIMER0_RELOAD_F)
	setb TR0
	cpl SOUND_OUT ; Connect speaker the pin assigned to 'SOUND_OUT'!
	reti
	Play_G:
	cjne a, #6, done
	clr TR0
	mov TH0, #high(TIMER0_RELOAD_G)
	mov TL0, #low(TIMER0_RELOAD_G)
	setb TR0
	cpl SOUND_OUT ; Connect speaker the pin assigned to 'SOUND_OUT'!
	reti
...
FSM1_state1_not_changed:
    ...
    jnc FSM1_state1_abort_check ; if no carry (temp < Temp_soak), go to FSM2 
	setb state_changed ;tells us the state was just changed :)
...
Abort_Time_Check: ;else check if time > 60s
	...
	ljmp FSM2 ;jumps to state 0 immediately to abort
FSM1_state1_done:
    ljmp FSM2
